...
– but serving people most of all. <!-- .element: class="fragment" data-fragment-index="2" -->
...
![my first Rust commit](./img/first-commit.png)<!-- .element: class="fragment" data-fragment-index="1" -->
...
![New Rustacean](./img/newrustacean.png)<!-- .element: class="fragment" data-fragment-index="1" -->
![Request for Explanation](./img/rfe.png)<!-- .element: class="fragment" data-fragment-index="2" -->
![Rusty Spike](./img/rusty-spike.png)<!-- .element: class="fragment" data-fragment-index="3" -->
...
We could use the same!<!-- .element: class="fragment" data-fragment-index="1" -->
...
You still have things to contribute.<!-- .element: class="fragment" data-fragment-index="1" -->
