...
![family](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/family.jpg)
...
Honestly, some of both – but serving people most of all. <!-- .element: class="fragment" data-fragment-index="2" -->
...
There is more work to be done than hands to do it. <!-- .element: class="fragment" data-fragment-index="1" -->

Always. <!-- .element: class="fragment" data-fragment-index="2" -->
...
How I got here: <!-- .element: class="fragment" data-fragment-index="1" -->

![my first Rust commit](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/first-commit.png)<!-- .element: class="fragment" data-fragment-index="1" -->
...
We're meant to help each other.<!-- .element: class="fragment" data-fragment-index="1" -->
...
That's it. Really! <!-- .element: class="fragment" data-fragment-index="1" -->

No quibbling! <!-- .element: class="fragment" data-fragment-index="2" -->

And no magic!<!-- .element: class="fragment" data-fragment-index="3" -->
...
Fix bugs! Implement features! etc.<!-- .element: class="fragment" data-fragment-index="1" -->

<p class="fragment" data-fragment-index="2">

![good first issue](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/good-first-issue.png) ![mentored](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/mentored.png) ![easy](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/easy.png)

</p>

These are all over the ecosystem. 🎉<!-- .element: class="fragment" data-fragment-index="2" -->
...
Remember: we want people to contribute!<!-- .element: class="fragment" data-fragment-index="1" -->

<p class="fragment" data-fragment-index="1">
![good first issue](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/good-first-issue.png)
![mentored](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/mentored.png)
![easy](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/easy.png)
</p>
...
Code is not the only contribution.<!-- .element: class="fragment" data-fragment-index="1" -->

It's not even the most important contribution.<!-- .element: class="fragment" data-fragment-index="1" -->

It's just the most obvious contribution.<!-- .element: class="fragment" data-fragment-index="1" -->
...
![filing bugs](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/new-issue.png)
...
![translation](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/translation.png)
...
So: bend the curve again.<!-- .element: class="fragment" data-fragment-index="1" -->

Make Rust stand out in this area.<!-- .element: class="fragment" data-fragment-index="1" -->
...
* If you're just flat bad at design (it's okay!), choose good tools<!-- .element: class="fragment" data-fragment-index="2" -->
...
* Think about information hierarchy, a.k.a. outlines<!-- .element: class="fragment" data-fragment-index="3" -->
...
It's okay if it feels hard.<!-- .element: class="fragment" data-fragment-index="1" -->

Writing words ≠ writing software.<!-- .element: class="fragment" data-fragment-index="1" -->

But you can do it!<!-- .element: class="fragment" data-fragment-index="2" -->
...
![New Rustacean](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/newrustacean.png)<!-- .element: class="fragment" data-fragment-index="1" --> ![Request for Explanation](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/rfe.png)<!-- .element: class="fragment" data-fragment-index="2" --> ![Rusty Spike](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/rusty-spike.png)<!-- .element: class="fragment" data-fragment-index="3" -->
...
People loved RailsCasts. It was a bootstrapper. We could use the same!<!-- .element: class="fragment" data-fragment-index="1" -->

If you have skillz with video, use them!<!-- .element: class="fragment" data-fragment-index="2" -->
...
Physicality matters. Presence matters.<!-- .element: class="fragment" data-fragment-index="1" -->

(We know this! We're at a conference!)<!-- .element: class="fragment" data-fragment-index="2" -->
...
What about all you old-timers? You still have things to contribute.<!-- .element: class="fragment" data-fragment-index="1" -->
...
1. Look for these!<!-- .element: class="fragment" data-fragment-index="1" -->
   ...
   ![help wanted](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/help-wanted.png) ![help wanted](https://f001.backblazeb2.com/file/chriskrycho-com/images/talks/rbr_2017/easy.png)
