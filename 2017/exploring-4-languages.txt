...
Why, though? Mostly because I think it’ll be interesting to compare the implementations of the domain model from the book side by side. It’ll look just a bit different in each language, and I expect to learn a bit more of the _feel_ of each language by doing this. (That side by side comparison is something I’ve [done before](http://v4.chriskrycho.com/rust-and-swift.html 'Series: Rust and Swift') and [found very profitable](http://v4.chriskrycho.com/2015/rust-and-swift-v.html 'Part V: The value (and challenge) of learning languages in parallel.').) I’ll also turn it into blog posts, which hopefully will be interesting to others!
