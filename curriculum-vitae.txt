...
As a **Senior Software Engineer** (May 2017–present), I led a team effort to expand our mobile web <abbr>UI</abbr> as a **responsive web <abbr>UI</abbr>** to reduce our maintenance burden, improve our overall <abbr>UX</abbr>, and decrease the cost of launching new features. I designed a new technical strategy for white-labeling (including the adoption of **<abbr>CSS</abbr> Modules**), enabling the business to support more brands by way of better tooling. I also finished our app's conversion to a fully strictly-type-checked TypeScript application.
